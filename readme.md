...
#### Funcionalidad:
- Elegir entre un dibujo prediseñado o uno armable interactivamente
- Un display adecuado para mejorar la visibilidad de las figuras
- Un set de comandos para interactuar y construir un dibujo en el momento. Los nuevos son:
- - agrandar o achicar la imagen
- - restablecer el dibujo a su forma inicial
- - revertir dibujo al estado anterior
- - rotar 45° sin reducir el tamaño de la imagen
#### Testing
- Pruebas para comprobar comportamiento esperado de las funciones
#### Extras
- Separación de dependencias segun se necesiten para correr el programa o testear funciones
