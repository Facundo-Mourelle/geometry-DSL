...
data Basica = Triangulo | Cuadrado | FormaF | Fish | FishHD | Empty
    deriving (Eq, Show)
...
cuadradoAzul :: ImagenFlotante
cuadradoAzul origen v1 v2 =
    pictures
        [ color blue $ polygon puntos
        , color white $ lineLoop puntos
        ]
  where
    puntos = map (origen V.+) [vCero, v1, v1 V.+ v2, v2]
...
interpBas dib = case dib of 
    Triangulo -> trianguloBorde
